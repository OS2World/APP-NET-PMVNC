...
const FileMap filemapping []  ={
    {"/vncviewer.jar", 300, IDR_VNCVIEWER_JAR, 20520},
    {"/authenticationPanel.class", 301, IDR_AUTHPANEL_CLASS, 2068},
    {"/clipboardFrame.class", 301, IDR_CLIPBOARDFRAME_CLASS, 1761},
    {"/DesCipher.class", 301, IDR_DESCIPHER_CLASS, 7143},
    {"/optionsFrame.class", 301, IDR_OPTIONSFRAME_CLASS, 3489},
    {"/rfbProto.class", 301, IDR_RFBPROTO_CLASS, 8309},
    {"/vncCanvas.class", 301, IDR_VNCCANVAS_CLASS, 6271},
    {"/vncviewer.class", 301, IDR_VNCVIEWER_CLASS, 7489},
    {"/animatedMemoryImageSource.class", 301, IDR_ANIMMEMIMAGESRC_CLASS, 1329} };
...
VBool vncHTTPConnect::Init(vncServer *server, UINT port)
{
    // Save the port id
    m_port = port;
