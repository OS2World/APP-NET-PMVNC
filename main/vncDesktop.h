...
#if !defined(_PMVNC_VNCDESKTOP)
#define _PMVNC_VNCDESKTOP
...
// Constants
extern ULONG RFB_SCREEN_UPDATE;
extern ULONG RFB_COPYRECT_UPDATE;
extern ULONG RFB_MOUSE_UPDATE;
...
public:
    ...
    friend MRESULT EXPENTRY DesktopWndProc(HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2);
    ...
    rfb::Rect MouseRect();
    void SetCursor(HPOINTER cursor);
